            ...
            <section className="h-screen bg-pink-500">
                <div className="m-auto block pt-16 pb-4 border-b-2 rounded mb-4 bg-white">
                    <div className="flex justify-center items-center mx-20 space-x-4">
                        <div className="px-7 py-3 mr-4 bg-pink-500 rounded-full">
                            <h2 className="text font-semibold text-center text-white ">
                                現在の MANEKIN 利用分析
                            </h2>
                        </div>

                        <div className="rounded-full px-9 py-3 bg-white">
                            <p className="font-bold text-sm text-center text-pink-500">
                                出品アイテム数
                            </p>
                ...
                <div className="container max-w-7xl mx-auto bg-white rounded-lg p-8">
                        ...
                        <div className="w-full lg:w-1/2 px-8">
                            <ul className="space-y-12">
                                <li className="flex -mx-4">
                                    <div className="px-4">
                                        <span className="flex w-16 h-16 mx-auto items-center justify-center text-2xl font-bold font-heading rounded-full bg-pink-50 text-pink-600">
                                            1
                                        </span>
                                    </div>
                                    <div className="px-4">
