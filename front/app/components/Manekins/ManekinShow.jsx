    ...
    <div className="bg-gray-100">
      <div className=" bg-white flex justify-center w-3/5 container mx-auto">
        <div className="flex-auto container mt-4 ml-8">
          <img src="#" alt="manekin-img" className="w-80 h-96 border border-gray-400 ml-8" />
          <div className="mt-8 ml-10">
            <h2 className="font-semibold">使用アイテム</h2>
            <ul className="my-6 mx-4">
              <li className="flex mb-4">
                <img src="#" alt="item-img" className="w-28 h-36 border border-gray-400 flex-none"/>
        ...
        <div className="flex-auto container mx-auto mt-2">
          ...
          <div>
            ...
            <div className="flex my-3">
              <img src="#" className="border border-gray-300 rounded-full w-12 h-12 flex-none ml-2"/>
          ...
          <textarea name="comment" cols="100" rows="5" placeholder="コメントする" className="border border-gray-300 w-11/12 rounded-lg"></textarea><br />
